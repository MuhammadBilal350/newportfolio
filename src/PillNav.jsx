...
const PillNav = ({
  ...
  const handleLogoEnter = () => {
    const logoEl = logoImgRef.current || logoRef.current;
    if (!logoEl) return;
  ...
  return (
    <div className="fixed top-4 left-1/2 -translate-x-1/2 z-[1000] w-full md:w-auto px-4 md:px-0">
      <nav
      ...
      >
        <a
          ...
          aria-label="Home"
          ref={logoRef}
          className="rounded-full inline-flex items-center justify-center overflow-hidden font-bold text-sm"
          style={{
            width: 'var(--logo)',
            height: 'var(--logo)',
        ...
        >
          <span ref={logoImgRef}>BILAL</span>
        </a>
